package com.uy.atiliator.sie.inspeccion.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("inspeccion");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("inspeccion");
        ...
        config.getMapConfigs().put("com.uy.atiliator.sie.inspeccion.domain.*", initializeDomainMapConfig(jHipsterProperties));
