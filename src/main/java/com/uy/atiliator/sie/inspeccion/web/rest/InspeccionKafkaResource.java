...
@RestController
@RequestMapping("/api/inspeccion-kafka")
public class InspeccionKafkaResource {

    private final Logger log = LoggerFactory.getLogger(InspeccionKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public InspeccionKafkaResource(KafkaProperties kafkaProperties) {
